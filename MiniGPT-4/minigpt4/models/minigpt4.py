...
class MiniGPT4(MiniGPTBase):
    ...
    def __init__(
            ...
            q_former_model="/fred/oz402/nhnguyen/Model/MiniGPT-4/pretrained/blip2_pretrained_flanT5xxl.pth",
            img_size=224,
            drop_path_rate=0,
    ...
    def from_config(cls, cfg):
        ...
        q_former_model = cfg.get("q_former_model", "/fred/oz402/nhnguyen/Model/MiniGPT-4/pretrained/blip2_pretrained_flanT5xxl.pth")
